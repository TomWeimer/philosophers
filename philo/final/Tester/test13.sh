...
if [ $DIED -eq 1 ]
	then
	{
		grep $3 $2 | awk '{ printf "\033[1;34m ["; if ($1 >= 200 && $1 <= 210) {printf "\033[3;32m ✓"; printf "\033[1;34m ] \033[0m" $1 "ms\n"} else {printf "\033[3;31m ✗"; printf "\033[1;34m ] \033[0m" $1 "ms expected 200 - 210ms\n"}} '
	}
else
	echo -en "$BLUE[$RED ✗ $BLUE] $RESET none\n"
fi

echo -en "$WHITE_BOLD 💻  ../philo 4 200 210 200 $RESET\n\n"
